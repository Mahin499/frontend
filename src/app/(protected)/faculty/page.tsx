...
import { Users, CheckCircle, Moon, BookOpen, Video, Clock, UserPlus, Eye, Meh, EyeOff, ArrowRight } from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div className="bg-surface-light dark:bg-surface-dark p-5 rounded-2xl border border-border-light dark:border-border-dark shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="text-xs font-bold text-slate-600 bg-slate-100 dark:text-slate-400 dark:bg-slate-800 px-2 py-0.5 rounded">Assigned</span>
                        </div>
                        <p className="text-slate-500 dark:text-slate-400 text-sm">My Classes</p>
                        <h3 className="text-3xl font-black text-slate-900 dark:text-white mt-1">4</h3>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-surface-light dark:bg-surface-dark rounded-2xl border border-border-light dark:border-border-dark p-6 shadow-sm">
                            <div className="flex justify-between items-center mb-6">
                                <div>
                                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">Attendance Trend &mdash; This Week</h3>
                                ...
                                <select className="bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-sm rounded-lg px-3 py-2 border-none focus:ring-2 focus:ring-primary outline-none">
                                    ...
                                    <option>BSE-Batch-2024</option>
                                </select>
                            </div>

                            <div className="h-48 w-full relative bg-slate-50 dark:bg-slate-800/50 rounded-xl flex items-center justify-center border border-dashed border-slate-200 dark:border-slate-700">
                                    ...
                                    <tbody className="divide-y divide-border-light dark:divide-border-dark">
                                        <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                            <td className="px-6 py-4">
                                                ...
                                                <div className="text-xs text-slate-500 dark:text-slate-400">Computer Science &bull; Sem 5</div>
                                            </td>
                                            ...
                                            <td className="px-6 py-4">
                                                <Link href="/session" className="inline-flex px-3 py-1.5 bg-primary/10 dark:bg-primary/20 text-primary text-xs font-semibold rounded-lg hover:bg-primary/20 dark:hover:bg-primary/30 transition-colors">
                                                    Take Attendance
                                                </Link>
                                            </td>
                                        </tr>
                        ...
                        <div className="bg-surface-light dark:bg-surface-dark rounded-2xl border border-border-light dark:border-border-dark p-6 shadow-sm">
                            ...
                            <div className="space-y-4 shadow-none">
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-1">
                                        <div className="flex items-center gap-2">
                                            <Eye className="text-emerald-600 dark:text-emerald-400" size={16} />
                                            <span className="text-sm text-slate-700 dark:text-slate-300 font-medium">Attentive Students</span>
                                        </div>
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-1">
                                        <div className="flex items-center gap-2">
                                            <Meh className="text-amber-500 dark:text-amber-400" size={16} />
                                            <span className="text-sm text-slate-700 dark:text-slate-300 font-medium">Distracted</span>
                                        </div>
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-1">
                                        <div className="flex items-center gap-2">
                                            <EyeOff className="text-indigo-600 dark:text-indigo-400" size={16} />
                                            <span className="text-sm text-slate-700 dark:text-slate-300 font-medium">Drowsy / Sleeping</span>
                                        </div>
                                        <span className="font-bold text-red-600 dark:text-red-400">7%</span>
                                    </div>
                                    <div className="h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                                        <div className="h-full bg-indigo-500 rounded-full" style={{ width: "7%" }}></div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-4 p-3 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-xl">
                                    ...
                                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">7 students flagged as drowsy in the last period. Review AI Validation Queue.</p>
                                    <Link href="/ai-validation" className="inline-flex mt-2 text-xs text-primary font-semibold hover:underline items-center gap-1">
